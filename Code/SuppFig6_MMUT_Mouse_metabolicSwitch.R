...
# b. Mmut expression
# c. GSEA KEGG pathways
# d. htmp glutathione metabolism
...
ggplot(tbl5b_supp, aes(x = variable, y = value, color = variable, fill = variable)) +
	...
	stat_compare_means(comparisons = list(c(mylvls[c(3,4)])), size = 3) +
...
plt5e_supp <- 
as.ggplot(pheatmap(tbl5e_supp_mat, scale = "row", annotation_col = df_types, cutree_cols = 1, cutree_rows = 1, show_colnames = FALSE, annotation_legend = FALSE, treeheight_col = 0, fontsize_row = 8, annotation_colors = ann_colors, border_color = NA, color = inferno(100))) + ggtitle("Fatty acid degradation") + margin + theme(plot.title = element_text(hjust = 0.5))
...
plt5f_supp <- 
as.ggplot(pheatmap(tbl5f_supp_mat, scale = "row", annotation_col = df_types, cutree_cols = 1, cutree_rows = 1, show_colnames = FALSE, annotation_legend = FALSE, treeheight_col = 0, fontsize_row = 8, annotation_colors = ann_colors, border_color = NA, color = inferno(100))) + ggtitle("Glucose transporters") + margin + theme(plot.title = element_text(hjust = 0.5))




# htmp glycolysis / gluconeogenesis
...
plt5g_supp <- 
as.ggplot(pheatmap(tbl5g_supp_mat, scale = "row", annotation_col = df_types, cutree_cols = 1, cutree_rows = 1, show_colnames = FALSE, annotation_legend = FALSE, treeheight_col = 0, fontsize_row = 8, annotation_colors = ann_colors, border_color = NA, color = inferno(100))) + ggtitle("Glycolysis and Gluconeogenesis") + margin + theme(plot.title = element_text(hjust = 0.5))
...
plt5h_supp <- 
as.ggplot(pheatmap(tbl5h_supp_mat, scale = "row", annotation_col = df_types, cutree_cols = 1, cutree_rows = 1, show_colnames = FALSE, annotation_legend = FALSE, treeheight_col = 0, fontsize_row = 8, annotation_colors = ann_colors, border_color = NA, color = inferno(100))) + ggtitle("Ketone body metabolism") + margin + theme(plot.title = element_text(hjust = 0.5))
...
plt5i_supp <- 
as.ggplot(pheatmap(tbl5i_supp_mat, scale = "row", annotation_col = df_types, cutree_cols = 1, cutree_rows = 1, show_colnames = FALSE, annotation_legend = FALSE, treeheight_col = 0, fontsize_row = 8, annotation_colors = ann_colors, border_color = NA, color = inferno(100))) + ggtitle("Glutathione metabolism") + margin + theme(plot.title = element_text(hjust = 0.5))
...
plt5_top <- 
ggarrange(plt5a_supp, plt5b_supp, plt5d_supp, nrow = 1, labels = c("a", "b", "c"), widths = c(2,0.6,2.5))
...
ggsave(paste(fig_path, "SuppFig6.png", sep = ""), plt5_supp, device = png(), width = 12, height = 14, bg = "white")
dev.off()

ggsave(paste(fig_path, "SuppFig6.pdf", sep = ""), plt5_supp, device = "pdf", width = 12, height = 14, bg = "white")
dev.off()
